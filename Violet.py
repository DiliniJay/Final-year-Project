...
def violet_Count():
    ...
    s2="E:\FYP\openCV\Hue\ColorDetect/violet.png"
    try:
        #os.remove(s1)
        os.remove(s2)
    except: pass
    ...
    mask = cv2.inRange(hsv, (135, 0, 0), (170, 255, 255))
    ...
    b=((c-a)/c)*100
    return b
#print("Violet percentage: %.2f"% violet_Count("https://upload.wikimedia.org/wikipedia/commons/thumb/7/7d/Color_icon_green.svg/2000px-Color_icon_green.svg.png"))