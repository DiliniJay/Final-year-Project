...
def red_Count():
    ...
    s2="E:\FYP\openCV\Hue\ColorDetect/red.png"
    try:
        #os.remove(s1)
        os.remove(s2)
    except: pass
    ...
    mask = cv2.inRange(hsv, (0, 0, 0), (15, 255, 255))
    ...
    b=((c-a)/c)*100
    return b
#print("Red percentage: %.2f"% red_Count("https://upload.wikimedia.org/wikipedia/commons/thumb/7/7d/Color_icon_green.svg/2000px-Color_icon_green.svg.png"))