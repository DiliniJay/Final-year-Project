...
def yellow_Count():
    ...
    s2="E:\FYP\openCV\Hue\ColorDetect/yellow.png"
    try:
        #os.remove(s1)
        os.remove(s2)
    except: pass
    ...
    b=((c-a)/c)*100
    return b
#print("Yellow percentage: %.2f"% yellow_Count("https://upload.wikimedia.org/wikipedia/commons/thumb/7/7d/Color_icon_green.svg/2000px-Color_icon_green.svg.png"))